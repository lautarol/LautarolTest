...
3. <span data-ttu-id="ef748-110">Onder **e-mailmeldingen**, opgeven welke meldingen moeten worden verzonden via e-mail: ze kunnen worden verzonden voor nieuwe waarschuwingen (verdachte activiteiten) en nieuwe statusproblemen.</span><span class="sxs-lookup"><span data-stu-id="ef748-110">Under **Mail notifications**, specify which notifications should be sent via email - they can be sent for new alerts (suspicious activities) and new health issues.</span></span> 
 ...
 > [!NOTE]
 > <span data-ttu-id="ef748-111">E-mailwaarschuwingen voor verdachte activiteiten worden alleen verzonden wanneer de verdachte activiteit zich voor het eerst voordoet.</span><span class="sxs-lookup"><span data-stu-id="ef748-111">Email alerts for suspicious activities are only sent when the suspicious activity is created.</span></span>

4. <span data-ttu-id="ef748-112">Klik op **Opslaan**.</span><span class="sxs-lookup"><span data-stu-id="ef748-112">Click **Save**.</span></span>
