...
# <a name="use-the-always-on-availability-group-dashboard-sql-server-management-studio"></a><span data-ttu-id="fbd15-102">Use the Always On Availability Group dashboard (SQL Server Management Studio)</span><span class="sxs-lookup"><span data-stu-id="fbd15-102">Use the Always On Availability Group dashboard (SQL Server Management Studio)</span></span>
  ...
  <span data-ttu-id="fbd15-103">Database administrators use the Always On Availability Group dashboard to obtain an at-a-glance view the health of an availability group and its availability replicas and databases in.</span><span class="sxs-lookup"><span data-stu-id="fbd15-103">Database administrators use the Always On Availability Group dashboard to obtain an at-a-glance view the health of an availability group and its availability replicas and databases in .</span></span> <span data-ttu-id="fbd15-104">Some of the typical uses for the availability group dashboard are:</span><span class="sxs-lookup"><span data-stu-id="fbd15-104">Some of the typical uses for the availability group dashboard are:</span></span>  
...
## <a name="prerequisites"></a><span data-ttu-id="fbd15-117">Prerequisites</span><span class="sxs-lookup"><span data-stu-id="fbd15-117">Prerequisites</span></span>  
 <span data-ttu-id="fbd15-118">You must be connected to the instance oeither the primary replica or a secondary replica of an availability group.</span><span class="sxs-lookup"><span data-stu-id="fbd15-118">You must be connected to the instance (server instance) that hosts either the primary replica or a secondary replica of an availability group.</span></span>  
...
1.  <span data-ttu-id="fbd15-122">In Object Explorer, connect to the instance ofich you want to run the Always On Dashboard.</span><span class="sxs-lookup"><span data-stu-id="fbd15-122">In Object Explorer, connect to the instance of  which you want to run the Always On Dashboard.</span></span>  
...
##  <a name="change-always-on-dashboard-options"></a><span data-ttu-id="fbd15-124">Change Always On Dashboard Options</span><span class="sxs-lookup"><span data-stu-id="fbd15-124">Change Always On Dashboard Options</span></span>  
 <span data-ttu-id="fbd15-125">You can use thure tways On Dashboard behavior for automatic refreshing and enabling an auto-defined Always On policy.</span><span class="sxs-lookup"><span data-stu-id="fbd15-125">You can use th**Options** dialog box to configure thelways On Dashboard behavior for automatic refreshing and enabling an auto-defined Always On policy.</span></span>  
...
<span data-ttu-id="fbd15-165">The **Availability replica** pane displays the following columns:</span><span class="sxs-lookup"><span data-stu-id="fbd15-165">The **Availability replica** pane displays the following columns:</span></span>  
 ...
 <span data-ttu-id="fbd15-170">Indicates the current role of the availability replica, either **Primary** or **Secondary**.</span><span class="sxs-lookup"><span data-stu-id="fbd15-170">Indicates the current role of the availability replica, either **Primary** or **Secondary**.</span></span> <span data-ttu-id="fbd15-171">For information abou, see [Overview of Always On Availability Groups &#40;SQL Server&#41;](../../../database-engine/availability-groups/windows/overview-of-always-on-availability-groups-sql-server.md).</span><span class="sxs-lookup"><span data-stu-id="fbd15-171">For information aboules, see [Overview of Always On Availability Groups &#40;SQL Server&#41;](../../../database-engine/availability-groups/windows/overview-of-always-on-availability-groups-sql-server.md).</span></span> <span data-ttu-id="fbd15-172">This column is shown by default.</span><span class="sxs-lookup"><span data-stu-id="fbd15-172">This column is shown by default.</span></span>  
...
-   <span data-ttu-id="fbd15-251">**Issues**</span><span class="sxs-lookup"><span data-stu-id="fbd15-251">**Issues**</span></span>  
 ...
 <span data-ttu-id="fbd15-257">The name of the instance ot hosts the availability replica.</span><span class="sxs-lookup"><span data-stu-id="fbd15-257">The name of the instancat hosts the availability replica.</span></span> <span data-ttu-id="fbd15-258">This value is shown by default.</span><span class="sxs-lookup"><span data-stu-id="fbd15-258">This value is shown by default.</span></span>  
